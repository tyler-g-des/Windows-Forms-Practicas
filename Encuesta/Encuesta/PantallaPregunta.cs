...
namespace Encuesta
{
    class PantallaPregunta
    {
        ...
        void ContinuarPreguntas(object sender, EventArgs e)
        {
            ...
            us.GuardarPreguntas(txtPregunta.Text, PantallaCrearEncuestas.txtNombreEncuentra.Text);

            PantallaCrearEncuestas.form.Close();
            form.Close(); 

            form.Close();
            PantallaEncuestas fr = new PantallaEncuestas();
            fr.crearPantalla();
        }
